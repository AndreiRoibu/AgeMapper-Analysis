...
subjects_ica=0;         % indicate if we are loading the subjects-ICA (1) or the features-ICA (0); default=1
...
short_run=1
;            % define if we want to run the entire set of J-values (0) or a shorter version (1); default=1
